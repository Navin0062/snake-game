...
// score of he player 
int playerScore; 
// coordinates of snake tail (x-axis,  y-axis) 
int snakeTailX[100], snakeTailY[100]; 
// length of the sanke's tail c
int snakeTailLen; 
// snake's moving snakesDirection 
...
// creating the game board & rendering 
...
{ 
	...
	cout << "\nSET DIFFICULTY\n1: Easy\n2: Medium\n3: hard "
			...
			"\nNOTE: To play use keys W->up , S->down , A->left , D->right"
